...
class DatabaseAccess(ABC):
    ...
    def delete_owner(self, user_id: str):
        """Delete owner from _database. Foreign key management will destroy all ownership data in PlatformOwners"""
...
class SQLiteDatabaseAccess(DatabaseAccess):
    ...
    def __init__(self, database_file: str):
        ...
        self._admin_ids = self._get_admin_list()
    ...
    def _get_admin_list(self) -> list[str]:
        """Returns a list of user IDs of all Admins from the database"""
    ...
    def refresh_admins(self) -> list[str]:
    ...
    def get_platform_list(self) -> dict[str, Platform]:
        """Returns the list of platforms"""
        return self._platforms

    def refresh_platforms(self):
        """Refresh the list of platorms"""
        self._platforms = self._get_platforms()
        return self._platforms
...
class OwnerNotInTable(Exception):
    """Custom exception for when a user is registered as an owner,
